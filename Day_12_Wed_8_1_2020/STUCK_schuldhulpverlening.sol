...
contract schuldHulpVerlening {
    ...
    constructor() public {
        debiteur.push(address(0)); //makes test easier
        derdePartij.push(address(0)); //make test easier
    ...
    function NrOfDerdePartij() public view returns (uint) {
        return derdePartij.length-1;
    }
        function NrOfDebiteur() public view returns (uint) {
        return debiteur.length-1;
    }
